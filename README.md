# 유전체의학연구실 · Laboratory of Genomic Medicine

**이화여자대학교 의과대학 · Ewha Womans University College of Medicine**

> 단일세포 유전체학과 다중오믹스 분석을 통해 질환 세포의 분자 언어를 해독합니다.  
> We decode the molecular language of disease cells through single-cell genomics and multi-omics analysis.

---

## Principal Investigator

**최지수 (Jeesoo Chae), Ph.D.**  
조교수 · Assistant Professor  
이화여자대학교 의과대학 융합의학교실 · 시스템헬스융합전공  
의학관(마곡) 512호
...
- 🔬 **단일세포 유전체학** — scRNA-seq, scATAC-seq, Spatial transcriptomics
- 🛡️ **면역세포 유전체학** — Myeloid cell, T cell 아형 분석
- 🧫 **줄기세포 유전체학** — 분화 및 자기재생 조절 기전
- 🦠 **질환 유전체학** — 암·희귀질환 체세포·생식세포 변이 발굴
- 📊 **다중오믹스 통합 분석** — 바이오마커 발굴 및 정밀의학
- 🤖 **생물정보학** — 대용량 유전체 데이터 분석 파이프라인 개발
...
| 과제명 | 재원 | 상태 |
|---|---|---|
| 기초연구실 지원사업 | 한국연구재단 | ✅ 진행 중 |
| 우수신진연구 씨앗과제 | 한국연구재단 | ✅ 진행 중 |
| 브릿지사업 | 이화여대 교내 | 완료 |
| 공동과제육성사업 | 이화여대 교내 | 완료 |
...
서울특별시 강서구 마곡동로2길 25  
이화여자대학교 의학관(마곡) 512호  
Tel. 02-6986-6307 · Fax. 02-6986-7016  
